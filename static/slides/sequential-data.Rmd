...
```{r weather-plot, dependson = "weather-import"}
...
```{r weather-plot-short, dependson = "weather-import"}
...
```{r weather-stack, dependson = "weather-generate-batches", echo=TRUE, results='hide'}
model <- keras_model_sequential() %>% 
...
```{r weather-stack-plot, dependson = "weather-stack", echo = FALSE}
plot(history)
```
