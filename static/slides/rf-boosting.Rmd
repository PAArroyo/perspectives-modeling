...
1. Fit the next decision tree to the residuals of the previous: $h_1(x) = y - F_1(x)$
1. Add this new tree to the algorithm: $F_2(x) = F_1(x) + h_1(x)$
1. Fit the next decision tree to the residuals of $F_2$: $h_2(x) = y - F_2(x)$
1. Add this new tree to the algorithm: $F_3(x) = F_2(x) + h_1(x)$
