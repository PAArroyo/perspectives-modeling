...
```{r imdb-small-compare-plot, echo = FALSE}
...
```{r imdb-model-big-plot, echo = FALSE}
plot_training_losses(losses = list(
  original_model = original_hist$metrics$val_loss,
...
```{r imdb-model-plot-train-loss, echo = FALSE}
plot_training_losses(losses = list(
...
```{r imdb-dropout-plot, echo = FALSE}
plot_training_losses(losses = list(
  original_model = original_hist$metrics$val_loss,
