...
```{r ames-ridge, dependson = "ames-train-matrix"}
...
```{r ames-ridge-tune, dependson = "ames-train-matrix"}
...
```{r ames-ridge-min-mse, dependson = "ames-ridge-tune"}
...
```{r ames-ridge-imp-vars, dependson = "ames-ridge"}
...
```{r lasso-example, dependson = "ridge-example"}
credit_lasso <- glmnet(
  x = credit_x,
  y = credit_y,
  alpha = 1
...
```{r ames-lasso, dependson = "ames-train-matrix"}
ames_lasso <- glmnet(
  x = ames_train_x,
  y = ames_train_y,
  alpha = 1
...
```{r ames-lasso-tune, dependson = "ames-train-matrix"}
...
```{r ames-lasso-min-mse, dependson = "ames-lasso-tune"}
...
```{r ames-lasso-imp-vars, dependson = "ames-lasso", fig.asp = .7}
...
```{r ames-elastic-net-tune, dependson = "ames-model-matrix"}
