...
##### Support for `e1701::naiveBayes()`

If you use R and the `naiveBayes` function from `e1701`, include the following code to allow `lime` to accept an `naiveBayes` object for the `explainer()` function:
