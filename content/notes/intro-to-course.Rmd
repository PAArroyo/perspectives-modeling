...
| 2 | Linear regression | Logistic regression/LDA |
| 3 | MLK (no class) | Prototype methods (naive Bayes & nearest neighbors) |
| 4 | Interpreting model results | Resampling methods |
| 5 | Linear model selection and regulation | Non-linear regression |
| 6 | Kernel smoothing methods | Support vector machines |
