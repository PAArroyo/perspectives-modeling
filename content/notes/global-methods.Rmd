...
```{r sim-linear}
sim_linear <- tibble(x = runif(100, 0, 10),
...
```{r sim-nonlinear}
sim_nonlinear <- tibble(x = runif(100, 0, 10),
...
```{r sim-piecewise}
# simulate data
sim_piece <- tibble(x = runif(100, 0, 10),
                        y = ifelse(x < 5,
