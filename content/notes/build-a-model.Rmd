...
A good model is almost always a statement about a process, and many bad models fail ecause they have no sense of process. When you build a model, look at it for a moment and see if it has some statement of process
